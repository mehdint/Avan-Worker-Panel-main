...
const getWoWConfig = async (env, client) => {
    ...
    wowConfigXray.remarks = '💦 Avan - Warp on Warp 🚀';
    ...
    warpConfigXray.remarks = '💦 Avan - Warp';
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/wow/${userID}#Avan-WoW', 'Warp on Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/wow/${userID}#Avan-WoW', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
					</tr>
					<tr>
						...
						<td>
                            <button onclick="copyToClipboard('https://${hostName}/wow/${userID}?app=singbox#Avan-WoW', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
						</td>
					</tr>
